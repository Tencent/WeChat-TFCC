...
# implement for https://tensorflow.google.cn/api_docs/python/tf/raw_ops/StopGradient?hl=en
class StopGradient(Converter):
    def __call__(self, op: Operation, graph: ir.framework.Graph):
        ...
        assert len(inp_strs) == 1 and len(oup_strs) == 1
