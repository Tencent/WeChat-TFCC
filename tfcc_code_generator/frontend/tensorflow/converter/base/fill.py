...
# implement for https://tensorflow.google.cn/api_docs/python/tf/raw_ops/Fill?hl=en
class Fill(Converter):
    def __call__(self, op: Operation, graph: ir.framework.Graph):
        ...
        graph.append_node(
            ir.node.base.CreateTensor(
                ...
                [to_vector_output],
                oup_strs,
                value=value_symbol.data,
                dtype=value_symbol.dtype,
            )
        )
