...
# implement for https://www.tensorflow.org/api_docs/cc/class/tensorflow/ops/maximum?hl=en
class Maximum(Converter):
    def __call__(self, op: Operation, graph: ir.framework.Graph):
        ...
        graph.append_node(ir.node.math.Max(op.name, graph, inp_strs, oup_strs))
        return True
