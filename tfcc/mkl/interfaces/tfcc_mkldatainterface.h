...
template <class T>
class MKLDataInterface : public DataInterface<T> {
...
template <class T>
class MKLDataInterface<Complex<T>> : public DataInterface<Complex<T>> {
  void set(Complex<T>* dst, const Complex<T>* data, size_t len) override;

  void set(Variable<Complex<T>>& a, const Complex<T>* data) override;
  void set(Variable<Complex<T>>& a, std::vector<Complex<T>>&& data) override;
  void get(const Tensor<Complex<T>>& a, Complex<T>* data) override;
  void zeros(Variable<Complex<T>>& a) override;
  void ones(Variable<Complex<T>>& a) override;

  Variable<Complex<T>> copy(const Tensor<Complex<T>>& a) override;
};
