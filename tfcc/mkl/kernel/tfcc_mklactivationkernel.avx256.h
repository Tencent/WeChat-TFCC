...
template <class T>
class _MKLActivationKernelAVX256 {
 public:
};
...
template <>
class _MKLActivationKernelAVX256<float> {
 public:
  ...
  static void powV2(const float* a, const float* exponent, float* b, unsigned total);
  static void powV3(const float* exponent, unsigned total, float a, float* b);
...
#  ifdef TFCC_USE_SVML
  ...
  static void geluAccurate(const float* a, unsigned total, float* b);
#  endif
};

template <>
class _MKLActivationKernelAVX256<double> {
 public:
  ...
  static void powV2(const double* a, const double* exponent, double* b, unsigned total);
  static void powV3(const double* exponent, unsigned total, double a, double* b);
