...
#include "tfcc_mklfusion_leakyrelu.h"

namespace tfcc {
namespace fusionop {

OperationType LeakyRelu::optype() const { return OperationType::LEAKYRELU; }

size_t LeakyRelu::input_count() const { return 2; }

std::shared_ptr<Register> LeakyRelu::process(
