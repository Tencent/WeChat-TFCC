...
class PyTorchLSTMCell {
 ...
 public:
  ...
  /**
   * @see PyTorchLSTMCell(unsigned units, std::string name)
   */
  explicit PyTorchLSTMCell(unsigned units);
   ...
   */
  PyTorchLSTMCell(unsigned units, std::string name);
