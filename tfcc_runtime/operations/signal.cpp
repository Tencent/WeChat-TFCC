...
#include "tfcc_runtime/operations/signal/irfft.h"
#include "tfcc_runtime/operations/signal/rfft.h"
...
std::vector<std::unique_ptr<Operation>> get_all_operations() {
  ...
  append_vector(operations, get_irfft_operations());
  append_vector(operations, get_rfft_operations());
  return operations;
}
